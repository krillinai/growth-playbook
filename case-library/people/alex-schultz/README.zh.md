...
他在 2017 年 Stanford CS183F 演讲《How to Get Users and Grow》中强调，没有PMF（产品市场匹配）和留存，获客技巧无法挽救产品。增长首先要理解谁留下、为什么留下，以及哪些早期行为能预测长期价值；之后才应该规模化渠道、信息和转化优化。
...
将付费搜索流量直接导向注册页，能获得更多注册用户；将用户导向其实际搜索的商品页，注册数反而下降，但激活用户、收入、每注册用户 LTV（客户生命周期价值）以及新增用户贡献的日收入都上升。
...
Alex 把增长技巧比作倒在火上的燃料。如果没有 PMF 和留存，就没有可被放大的火种。广告、公关、SEO（搜索引擎优化）、邮件和病毒机制都无法为用户不需要的产品创造长期增长。
...
- [GEO（生成式引擎优化）完全指南](../../../handbook/geo/README.zh.md)
