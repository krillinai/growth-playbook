...
OEC（总体评估指标，Overall Evaluation Criterion）表示组织真正希望改善的结果。短期敏感度需要继续连接到长期客户和业务价值。
...
Sample-Ratio Mismatch 可能来自分组、曝光、资格、身份、日志、过滤或排除缺陷。重大 SRM（样本比例失配）得到调查前，不应解释处理效应。
