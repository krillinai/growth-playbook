...
**保留的证据。** 公司页把推荐参与连接到接收者激活、留存质量、奖励成本与滥用。后续 PLG（产品驱动增长）证据把共享文件和协作使用视为分发与扩张信号，但不假定它们能够证明购买准备度。

**迁移边界。** 奖励不能创造 PMF（产品市场匹配）。需要衡量存储经济性、服务成本、作弊、身份、非活跃席位、权限与账户价值。案例没有建立跨 Dropbox 不同时期的一条连续因果历史。
...
| 多个产品共享激励与分发 | 字节跳动 | 共享控制、奖励后 Cohort（同期群）、产品组合增量与反作弊 | 活动峰值或单产品增长会提高产品组合总价值 |
