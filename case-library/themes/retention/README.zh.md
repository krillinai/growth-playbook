...
> 对比 Cohort（同期群）留存、重复价值、习惯、网络、已存价值、协作、增长核算、召回与生命周期干预。
...
**主要边界：**Pinterest 的视觉发现、内容供给、SEO（搜索引擎优化）界面与消费产品节奏不同于交易、企业与低频产品。
...
**主要边界：**已有叙述覆盖早期推荐、后续 PLG（产品驱动增长）与 AI 产品时期，不是一条连续完整的内部留存历史。
...
- [Casey Winters](../../people/casey-winters/README.zh.md)：把留存作为 PMF（产品市场匹配）证据、Setup-Aha-Habit、节奏、定性研究与增长组织。
