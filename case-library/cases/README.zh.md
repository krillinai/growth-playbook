...
| 案例 | 阶段 | 核心问题 | 页面 |
| --- | --- | --- | --- |
| Airtable 激活与早期增长 | 灵活 B2B 产品采用 | 客户洞察、新用户引导和协作信号如何让灵活价值更容易被采用？ | [阅读案例](airtable-activation-growth/README.zh.md) |
| 字节跳动增长基础设施 | 规模化多产品增长 | 增长如何成为跨产品、渠道与市场的可复用基础设施？ | [阅读案例](bytedance-growth-infrastructure/README.zh.md) |
| 字节跳动激励增长 | 激励获客与生命周期增长 | 红包、裂变、优惠券与极速版如何在控制作弊与蚕食的前提下创造增量价值？ | [阅读案例](bytedance-incentive-growth/README.zh.md) |
