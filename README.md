...
| **Activation & Conversion** | How new users reach value and take the next meaningful action | [Activation](handbook/activation/README.md)<br>[Onboarding](handbook/activation/README.md#onboarding)<br>[Setup, Aha & Habit](handbook/activation/README.md#setup-aha-and-habit)<br>[CRO](handbook/activation/README.md#conversion-rate-optimization) |
