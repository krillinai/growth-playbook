...
| **Companies** | Company overview pages that connect multiple cases, people, channels, and stages | ● [Airtable](case-library/companies/airtable/README.md)<br>● [ByteDance](case-library/companies/bytedance/README.md)<br>● [Duolingo](case-library/companies/duolingo/README.md)<br>● [Facebook / Meta](case-library/companies/facebook/README.md)<br>● [Lovable](case-library/companies/lovable/README.md) |
